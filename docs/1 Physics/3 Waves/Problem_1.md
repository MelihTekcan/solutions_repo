...
A wave traveling along a string is described by the equation:

$$
y(x, t) = 0.05 \sin(4\pi x - 20\pi t)
$$
...
5. What is the direction of wave propagation?
...
### **1. Amplitude ($$A$$)**
The amplitude is the coefficient of the sine function. From the equation:
$$
A = 0.05 \, \text{m}
$$
...
k = \frac{2\pi}{\lambda}
$$
From the equation, $$k = 4\pi$$. Solving for $$\lambda$$:
$$
...
\omega = 2\pi f
$$
From the equation, $$\omega = 20\pi$$. Solving for $$f$$:
$$
...
v = f \lambda
$$
Substitute $$f = 10 \, \text{Hz}$$ and $$\lambda = 0.5 \, \text{m}$$:
$$
v = 10 \times 0.5 = 5 \, \text{m/s}
$$

### **5. Direction of Wave Propagation**
The wave equation is of the form:
$$
y(x, t) = A \sin(kx - \omega t)
$$
The negative sign in $$kx - \omega t$$ indicates the wave is traveling in the **positive x-direction**.

---

## **Final Answers**

1. **Amplitude**: $$0.05 \, \text{m}$$  
2. **Wavelength**: $$0.5 \, \text{m}$$  
3. **Frequency**: $$10 \, \text{Hz}$$  
4. **Wave Speed**: $$5 \, \text{m/s}$$  
5. **Direction**: Positive x-direction.
